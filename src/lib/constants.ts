...
export const STAGING_SERVICE = 'https://staging.grapevyne.dev'
export const BSKY_SERVICE = 'https://grapevyne.social'
export const PUBLIC_BSKY_SERVICE = 'https://public.api.bsky.app'
export const DEFAULT_SERVICE = BSKY_SERVICE
const HELP_DESK_LANG = 'en-us'
export const HELP_DESK_URL = `https://grapevyneweb.zendesk.com/hc/${HELP_DESK_LANG}`
